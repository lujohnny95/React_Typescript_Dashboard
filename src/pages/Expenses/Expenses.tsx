            ...
            <main className={styles.expenses}>
                <div className={styles.expensesCard}>
                    <section className={styles.expensesOverview}>
                        ...
                        {/* Bar chart */}
                        <p className={styles.dateRange}>01 - 30 March, 2022</p>
                        ...
                        {/* Previous individual expenses */}
                        <div className={styles.expensesOverviewHeader}>
                            <p className={styles.expensesOverviewTitle}>Saturday, 26th March 2022</p>
                            <button>
                                <img src={optionIcon} alt="options" className={styles.expenseOption} />
                            </button>
                        </div>
